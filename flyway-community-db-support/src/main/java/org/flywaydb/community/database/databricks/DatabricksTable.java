...
public class DatabricksTable extends Table<DatabricksDatabase, DatabricksSchema> {
    ...
    protected boolean doExists() throws SQLException {
        ...
        return jdbcTemplate
                .queryForInt("select count(table_name) from " + database.getCatalog() +".information_schema.tables where table_schema = ? and table_name = ? and table_type='MANAGED';", schema.getName(), name) > 0;
    }
